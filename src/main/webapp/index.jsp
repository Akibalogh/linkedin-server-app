  ...
  <div id="page">
    ...
    <div class="width100 floatRight">
      ...
      <div class="gradient">
        ...
        <p>
	<a href="servlet/LinkedInLogin">
        <img src="images/sign-in-linkedin.png" style="border-style: none">
        </p>
      </div>
...
<div id="footer">
  ...
  <div id="width">
    ...
    <span class="floatRight">
      <a href="index.jsp" title="Introduction">Home</a> <span class="grey">|</span>
      <a href="index.jsp" title="View the styled tags">About Us</a> <span class="grey"></span>
    </span>
  </div>
